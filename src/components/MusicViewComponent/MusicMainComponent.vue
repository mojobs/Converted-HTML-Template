<template>
  ...
  >
    ...
    <div class="text-center pb-48">
      <a href="#">
        <img src="@/assets/img/content/placeholder_970_1.jpg" alt="" />
      </a>
    </div>
      ...
      <div class="video-playlist">
        <div class="video-playlist__content thumb-container">
          <div class="embed-responsive embed-responsive-16by9">
            <iframe
              src="https://www.youtube.com/embed/E0wW9RwpG7M?feature=oembed"
        ...
        <div class="video-playlist__list">
          <a
            href="https://www.youtube.com/embed/E0wW9RwpG7M?feature=oembed&autoplay=1"
            class="video-playlist__list-item video-playlist__list-item--active"
          >
            <div class="video-playlist__list-item-thumb">
              <img
                data-src="https://i.ytimg.com/vi/E0wW9RwpG7M/default.jpg"
            ...
            <div class="video-playlist__list-item-description">
              <h4 class="video-playlist__list-item-title">
                Heaven - Bryan Adams (cover) Megan Nicole and Boyce Avenue
              </h4>
            </div>
          </a>
          <a
            href="https://www.youtube.com/embed/7TWkmy5ELJc?feature=oembed&autoplay=1"
            class="video-playlist__list-item"
          >
            <div class="video-playlist__list-item-thumb">
              <img
                data-src="https://i.ytimg.com/vi/7TWkmy5ELJc/default.jpg"
            ...
            <div class="video-playlist__list-item-description">
              <h4 class="video-playlist__list-item-title">
                Santa Cruz - Young Blood Rising (Official Music Video)
              </h4>
            </div>
          </a>
          <a
            href="https://www.youtube.com/embed/hXnMSaK6C2w?feature=oembed&autoplay=1"
            class="video-playlist__list-item"
          >
            <div class="video-playlist__list-item-thumb">
              <img
                data-src="https://i.ytimg.com/vi/hXnMSaK6C2w/default.jpg"
                src="https://i.ytimg.com/vi/mn6Ia5e_suY/default.jpg"
                class="video-playlist__list-item-img lazyload"
                alt=""
              />
          ...
          <a
            href="https://www.youtube.com/embed/xMTsul4UFl8?feature=oembed&autoplay=1"
            class="video-playlist__list-item"
          >
            <div class="video-playlist__list-item-thumb">
              <img
                data-src="https://i.ytimg.com/vi/xMTsul4UFl8/default.jpg"
                src="https://i.ytimg.com/vi/mn6Ia5e_suY/default.jpg"
                class="video-playlist__list-item-img lazyload"
                alt=""
              />
          ...
          <a
            href="https://www.youtube.com/embed/2Vv-BfVoq4g?feature=oembed&autoplay=1"
            class="video-playlist__list-item"
          >
            <div class="video-playlist__list-item-thumb">
              <img
                data-src="https://i.ytimg.com/vi/2Vv-BfVoq4g/default.jpg"
                src="https://i.ytimg.com/vi/mn6Ia5e_suY/default.jpg"
                class="video-playlist__list-item-img lazyload"
                alt=""
              />
          ...
          <article class="entry">
            ...
            <div class="entry__body">
              <div class="entry__header">
                <h2 class="entry__title">
                  <a href="single-post-music.html"
                    >Zedd, Maren Morris &amp; Grey's 'The Middle' Hits No. 1 on
                    Pop Songs Airplay Chart</a
                  >
                </h2>
                <ul class="entry__meta">
                  <li class="entry__meta-author">
          ...
          <article class="entry thumb thumb--size-3 thumb--mb-20">
            ...
            >
              ...
              <div class="thumb-text-holder thumb-text-holder--2">
                ...
                <h2 class="thumb-entry-title">
                  <a href="single-post-music.html"
                    >WATCH Suprise Performance, Shoots Whiskey at Nashville’s
                    Bluebird Cafe</a
                  >
                </h2>
                <ul class="entry__meta">
          ...
          <article class="entry">
            ...
            <div class="entry__body">
              <div class="entry__header">
                <h2 class="entry__title">
                  <a href="single-post-music.html"
                    >Download Festival Rocks Melbourne, Prepares to Expand in
                    2019</a
                  >
                </h2>
                <ul class="entry__meta">
      ...
      >
        <article class="entry thumb thumb--size-1">
          <div
            class="entry__img-holder thumb__img-holder"
            style="
              background-image: url('img/content/carousel/carousel_post_16.jpg');
            "
          >
            <div class="bottom-gradient"></div>
        ...
        <article class="entry thumb thumb--size-1">
          <div
            class="entry__img-holder thumb__img-holder"
            style="
              background-image: url('img/content/carousel/carousel_post_17.jpg');
            "
          >
            <div class="bottom-gradient"></div>
            <div class="thumb-text-holder">
        ...
        <article class="entry thumb thumb--size-1">
          <div
            class="entry__img-holder thumb__img-holder"
            style="
              background-image: url('img/content/carousel/carousel_post_18.jpg');
            "
          >
            <div class="bottom-gradient"></div>
            <div class="thumb-text-holder">
              <h2 class="thumb-entry-title">
                <a href="single-post-music.html">
                  9 Standout moments of Demi Lovato’s Tell Me You</a
                >
              </h2>
            </div>
            <a href="single-post-music.html" class="thumb-url"></a>
        ...
        <article class="entry thumb thumb--size-1">
          <div
            class="entry__img-holder thumb__img-holder"
            style="
              background-image: url('img/content/carousel/carousel_post_19.jpg');
            "
          >
            <div class="bottom-gradient"></div>
            <div class="thumb-text-holder">
              <h2 class="thumb-entry-title">
                <a href="single-post-music.html"
                  >Which Artist Is Dominating 2018 So Far? Vote!</a
                >
              </h2>
            </div>
            <a href="single-post-music.html" class="thumb-url"></a>
